...
- Course Level: Choice (Content Level)
- Description: Memo
...
- Attendance Method: Choice (Participation Mode)
- Location: Lookup (Location)
- Is Excused: Yes / No
- Excuse Reason: Memo
...
- Accrediting Body: Lookup (Account)
...
- Accreditation Body: Lookup (Account)
