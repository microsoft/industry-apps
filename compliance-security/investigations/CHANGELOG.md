...
### Added
- Icons: Assigned custom table icons for all Investigations entities
...
### Added
- Forms: Configured quick create forms for all Investigations entities including streamlined field layouts for rapid data entry
- Subgrids: Configured related subgrids for all applicable Investigations entities to enable comprehensive related record navigation and management
